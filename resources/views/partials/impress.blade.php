...
<div class="receipt-main col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
          ...
          <div class="col-xs-6 col-sm-6 col-md-6 ">
            <div class="receipt-right">
              <h5>Clínica San Pablo</h5>
              <p><i class="fa fa-phone"></i> Numero : +91 12345-6789 </p>
              <p><i class="fa fa-envelope-o"></i> Email : info@gmail.com </p>
              <p><i class="fa fa-location-arrow"></i> Direccion :  </p>
            </div>
          </div>
...
<br>
      <div class="row">
          ...
          <div class="col-xs-8 col-sm-8 col-md-8 text-left">
            <div class="receipt-right">
              <h5>Ronald Dante Lindo <small>  |   Hora de Atención : 14:00 - 15:00</small></h5>
              <p><b>DNI :</b> 76188250</p>
              <p><b>Celular :</b> +91 12345-6789</p>
              <p><b>Email :</b> info@gmail.com</p>
              <p><b>Direccion :</b> Calle los alisos urb. Angelica Gamarra</p>
            </div>
          </div>
